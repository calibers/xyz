        ...
        $.each( data, function( key, val ) {
            ...
            if(myTags.indexOf(' ')>-1){
                ...
                for(var n in arrayTag){
                    items.push("<a href='#"+arrayTag[n]+"'><button class='active "+arrayTag[n]+"1' >"+arrayTag[n]+"</button></a>");
                }
            }else{
                 items.push( "<li class='myText' id='" + key + "'><h5>"+val.Name+"</h5><p>"+ val.Description +"</p><div class='the-tags'><a href='#"+val.Tags+"'><button class='active "+val.Tags+"1'>"+val.Tags+"</button></a>");
            }             
            //links 
