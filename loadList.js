...
(function() {
    ...
    $.getJSON( "data.json", function( data ) {
        ...
        $.each( data, function( key, val ) {
            ...
            //links 
            //display all links, if all present, if no twitter link or no linkedin link don't show icons for the two
            if(val.Website!=""&&val.Twitter!=""&&val.LinkedIn!=""){
                ...
                items.push( "</div></li><li id='" + key + "'><ul class='links'><li class='link' id='website'><a href='" + val.Website + "' class='ss-icon' target='_blank'>"+lin+"</a></li><li class='link' id='linkedin'><a href='" + val.LinkedIn +"'class='ss-icon'  target='_blank'>"+'&#xF612;'+"</a></div></ul></li></div></div></div>" );
            }else if(val.LinkedIn===""){
                items.push( "</div></li><li id='" + key + "'><ul class='links'><li class='link' id='website'><a href='" + val.Website + "' class='ss-icon' target='_blank'>"+lin+"</a></li><li class='link' id='twitter'><a href='" + val.Twitter+"' class='ss-icon' target='_blank'>"+'&#xF611;'+"</a></li></div></ul></li></div></div></div>" );
            }
        });
            $( "<ul/>", {
                 "class": "my-new-list",
